...
ee.Authenticate()
ee.Initialize(project="boxwood-dynamo-419312")  #not going to put my actual project id here for obvious reasons, especially cuz i wanna make this public sometime. Just know that it goes here for stuff like colab
